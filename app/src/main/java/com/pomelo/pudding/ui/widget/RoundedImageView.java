...
/**
 * Created by Sherry on 2019/10/21
 * 圆角矩形或圆形ImageView
 */
public class RoundedImageView extends AppCompatImageView {
    ...
    private void updateAttrs(Drawable drawable) {
        ...
        if (drawable instanceof RoundedDrawable) {
            ((RoundedDrawable) drawable).setOval(isOval).setScaleType(mScaleType).setCornerRadius(cornerRadius).setBorderWidth(borderWidth).setBorderColor(borderColor);
    ...
    public void setCornerRadiusResources(int resId) {
    ...
    public void setBorderWidthResources(int resId) {
