...
import com.pomelo.pudding.pickerview.adapter.WheelAdapter;
...
public class WheelView extends View {
    ...
    private void initPaints() {
        ...
        paintCenterText.setTextScaleX(1.3F);
    ...
    public final void setCustomTextSizeEnable(boolean enable) {
        customTextSize = !enable;
    }
