...
public class CacheUtils {
    ...
    public static CacheUtils get(Context context, String cacheName) {
    ...
    public static CacheUtils get(Context context, long max_size, int max_count) {
        File f = new File(context.getCacheDir(), "CacheUtils");
        return get(f, max_size, max_count);
    }

    public static CacheUtils get(File cacheDir, long max_size, int max_count) {
